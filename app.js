...
const countries = {
    list: [ 
        ...
        {name: 'Kiribati', code: 'KI'}, {name: 'Korea, Democratic People\'S Republic of', code: 'KP'}, {name: 'North Korea', code: 'KP'}, {name: 'Korea, Republic of', code: 'KR'}, {name: 'South Korea', code: 'KR'},{name: 'Kuwait', code: 'KW'}, {name: 'Kyrgyzstan', code: 'KG'}, 
